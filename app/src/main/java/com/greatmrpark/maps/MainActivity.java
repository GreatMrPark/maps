...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FloatingActionButton fabPlace = (FloatingActionButton) findViewById(R.id.fabPlace);
    ...
    public void setDefaultLocation() {
        ...
        CameraUpdate cameraUpdate = CameraUpdateFactory.newLatLngZoom(DEFAULT_LOCATION, DEFAULT_ZOOM);
        mGoogleMap.moveCamera(cameraUpdate);
    ...
    /**
     * Android Google Map에 현재 위치 주변의 음식점 표시하기
     * @param
     */
    public void showPlaceInformation(LatLng location) {

        Log.d(TAG, "showPlaceInformation : 지도 클리어");
        mGoogleMap.clear();

        new NRPlaces.Builder()
                .listener(MainActivity.this)
                .key("AIzaSyCVAXOTSDDUAP0fNX3wuEKhbtsf_ByKYPc")
